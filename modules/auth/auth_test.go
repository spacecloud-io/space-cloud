...
func TestIsAuthorized(t *testing.T) {
	...
	for i, test := range authIsAuthorized {
		t.Run(test.testName, func(t *testing.T) {
			(*authModule).rules = test.authModuleRules
			err := authModule.IsAuthorized(test.dbType, test.col, test.query, test.args)
			if i <= successTestCases {
...
func TestIsAuthenticated(t *testing.T) {
	...
	for i, test := range authIsAuthenticated {
		t.Run(test.testName, func(t *testing.T) {
			authModule.SetConfig(test.secretKey, test.authModuleRules, nil)
