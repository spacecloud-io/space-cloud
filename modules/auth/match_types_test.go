...
func TestMatchString(t *testing.T) {
	var testCases = []struct {
		...
		{name: "Match String in loaded from state-Fail", isErrExpected: false, args: map[string]interface{}{"v1": "var", "v2": []interface{}{"suyash", "var"}}, rule: &config.Rule{Rule: "Rule", Eval: "in", Type: "string", F1: "args.v1", F2: "args.v2"}},
