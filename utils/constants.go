...
const (
	...
	// TypeRealtimeSubscribeNeglectInitial is the request type for live query subscription
	TypeRealtimeSubscribeNeglectInitial string = "realtime-subscribe-neglect-initial"
