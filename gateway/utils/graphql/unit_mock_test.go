...
func (m *mockGraphQLCrudInterface) Read(ctx context.Context, dbAlias, collection string, request *model.ReadRequest, params model.RequestParams) (interface{}, map[string]interface{}, error) {
	args := m.Called(ctx, dbAlias, collection, request, params)
	return args.Get(0), args.Get(1).(map[string]interface{}), args.Error(2)
}
...
func (m *mockGraphQLCrudInterface) ExecPreparedQuery(ctx context.Context, dbAlias, id string, req *model.PreparedQueryRequest, params model.RequestParams) (interface{}, map[string]interface{}, error) {
