...
// 			args:   args{admin: &config.Admin{Version: 1}},
// 			fields: fields{config: &config.Admin{Version: 1}, quotas: model.UsageQuotas{}},
// 			want:   &Manager{config: &config.Admin{Version: 1}, quotas: model.UsageQuotas{MaxDatabases: 1, MaxProjects: 1}},
// 		},
// 	}
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
...
// 				},
// 			},
// 			want: &Manager{clusterID: "", user: &config.AdminUser{User: "admin", Pass: "123", Secret: "some-secret"}, quotas: model.UsageQuotas{MaxProjects: 1, MaxDatabases: 1}, config: &config.Admin{}},
// 		},
// 	}
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
