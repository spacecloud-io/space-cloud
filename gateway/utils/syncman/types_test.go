...
func (m *mockAdminSyncmanInterface) ValidateProjectSyncOperation(projects []string, projectID string) bool {
...
func (m *mockModulesInterface) SetProjectConfig(config *config.Project, le *letsencrypt.LetsEncrypt, ingressRouting *routing.Routing) error {
	return m.Called(config, le, ingressRouting).Error(0)
}
...
func (m *mockModulesInterface) ProjectIDs() []string {
