...
func (s *Manager) SetEventingConfig(ctx context.Context, project, dbAlias string, processingConfig int, enabled bool, params model.RequestParams) (int, error) {
	// Acquire a lock
	s.lock.Lock()
	defer s.lock.Unlock()
	...
	projectConfig.EventingConfig.ProcessingConfig = processingConfig
