...
func (s *Manager) SetGlobalRouteConfig(ctx context.Context, project string, globalConfig *config.GlobalRoutesConfig, params model.RequestParams) error {
	// Acquire a lock
	s.lock.Lock()
	defer s.lock.Unlock()
...
func (s *Manager) GetGlobalRouteConfig(ctx context.Context, project string, params model.RequestParams) (*config.GlobalRoutesConfig, error) {
	// Acquire a lock
	s.lock.Lock()
	defer s.lock.Unlock()
