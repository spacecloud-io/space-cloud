...
func Test_generateInspection(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    model.Collection{"table1": model.Fields{firstColumn: &model.FieldType{FieldName: firstColumn, IsFieldTypeRequired: true, Kind: model.TypeID, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}}}},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			want:    model.Collection{"table1": model.Fields{firstColumn: &model.FieldType{FieldName: firstColumn, IsFieldTypeRequired: true, Kind: "ID", IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}}}},
			wantErr: false,
		},
		// postgres
		{
