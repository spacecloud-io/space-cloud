	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"mysql": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
				currentSchema: model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}}},
			},
			fields:  fields{crud: crudMySQL, project: "test"},
			want:    []string{},
			wantErr: false,
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"mysql": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}, "col3": &model.FieldType{FieldName: "col3", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
		...
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"mysql": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
				currentSchema: model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}}},
			},
			fields:  fields{crud: crudMySQL, project: "test"},
			want:    []string{},
			wantErr: false,
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"mysql": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}, "col3": &model.FieldType{FieldName: "col3", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
				currentSchema: model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}, "col3": &model.FieldType{FieldName: "col3", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}}},
			},
			fields:  fields{crud: crudMySQL, project: "test"},
			want:    []string{},
		...
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"mysql": model.Collection{"table1": model.Fields{"id": &model.FieldType{FieldName: "id", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col1": &model.FieldType{FieldName: "col1", Kind: model.TypeInteger, IsIndex: true, IndexInfo: &model.TableProperties{Group: "i1", ConstraintName: getIndexName("table1", "i1"), Order: 1, Sort: "asc"}}, "col2": &model.FieldType{FieldName: "col2", Kind: model.TypeInteger, IsIndex: true, IndexInfo: &model.TableProperties{Group: "i1", ConstraintName: getIndexName("table1", "i1"), Order: 2, Sort: "asc"}}}}},
				currentSchema: model.Collection{"table1": model.Fields{"id": &model.FieldType{FieldName: "id", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col1": &model.FieldType{FieldName: "col1", Kind: model.TypeInteger, IsIndex: true, IndexInfo: &model.TableProperties{Group: "i1", ConstraintName: getIndexName("table1", "i1"), Order: 1, Sort: "asc"}}}},
			},
			fields:  fields{crud: crudMySQL, project: "test"},
		...
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"sqlserver": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}, "col3": &model.FieldType{FieldName: "col3", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
				currentSchema: model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}, "col3": &model.FieldType{FieldName: "col3", IsIndex: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}}},
			},
			fields:  fields{crud: crudSQLServer, project: "test"},
			want:    []string{},
		...
		},
		{
			...
			args: args{
				...
				project:       "test",
				parsedSchema:  model.Type{"postgres": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
				currentSchema: model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, TypeIDSize: model.SQLTypeIDSize}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}}},
			},
			fields:  fields{crud: crudPostgres, project: "test"},
			want:    []string{},
			wantErr: false,
		},
		{
			...
			args: args{
				...
				tableName:     "table1",
				project:       "test",
				parsedSchema:  model.Type{"postgres": model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID}, "col3": &model.FieldType{FieldName: "col3", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, TypeIDSize: model.SQLTypeIDSize, Kind: model.TypeID}}}},
				currentSchema: model.Collection{"table2": model.Fields{"id": &model.FieldType{FieldName: "id", IsFieldTypeRequired: true, IsPrimary: true}}, "table1": model.Fields{"col1": &model.FieldType{FieldName: "col1", Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize, IsPrimary: true, PrimaryKeyInfo: &model.TableProperties{}, IsFieldTypeRequired: true}, "col2": &model.FieldType{FieldName: "col2", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 1, Sort: "asc"}, Kind: model.TypeID}, "col3": &model.FieldType{FieldName: "col3", IsUnique: true, IndexInfo: &model.TableProperties{Group: "group1", Order: 2, Sort: "asc"}, Kind: model.TypeID, TypeIDSize: model.SQLTypeIDSize}}},
			},
			fields:  fields{crud: crudPostgres, project: "test"},
			want:    []string{},
