	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				store: map[string]interface{}{"vars": map[string]interface{}{"abc": 1}},
			},
			want: 1,
		}, {
			...
			args: args{
				...
				store: map[string]interface{}{"a": map[string]interface{}{"b": map[string]interface{}{"c": 69}}},
			},
			want: 69,
		}, {
			...
			args: args{
				...
				store: map[string]interface{}{"a": map[string]interface{}{"b": map[string]interface{}{"c": 69}, "cdbb": 2}},
			},
			want: 69,
		}, {
			...
			args: args{
				...
				store: map[string]interface{}{"a": map[string]interface{}{"ba": map[string]interface{}{"c": 69}, "b": 8}},
			},
			wantErr: true,
		}, {
			name: "default case",
