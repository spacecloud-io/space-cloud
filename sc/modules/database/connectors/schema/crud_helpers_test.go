	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				schemaDoc: model.CollectionSchemas{"table1": model.FieldSchemas{"col2": &model.FieldType{FieldName: "col2", Kind: model.TypeDateTime}}},
			},
		...
		},
		{
			...
			args: args{
				...
				col:       "table1",
				find:      map[string]interface{}{"col2": "2014-11-12T11:45:26.371Z"},
				schemaDoc: model.CollectionSchemas{"table1": model.FieldSchemas{}},
			},
			want:    map[string]interface{}{"col2": "2014-11-12T11:45:26.371Z"},
			wantErr: false,
		},
		...
		},
		{
			...
			args: args{
				...
				schemaDoc: model.CollectionSchemas{"table1": model.FieldSchemas{"col2": &model.FieldType{FieldName: "col2", Kind: model.TypeBoolean}}},
			},
