...
// GenerateTableSDL returns the sdl for the provided table
func GenerateTableSDL(schemaCol model.CollectionSchemas) (string, error) {
	schema := "{{define \"renderColumn\" }}" +
		...
		"{{if and $fieldValue.LinkedTable.Table $fieldValue.LinkedTable.From $fieldValue.LinkedTable.To $fieldValue.LinkedTable.To $fieldValue.LinkedTable.DB $fieldValue.LinkedTable.Field}}" +
		"@link(table: \"{{$fieldValue.LinkedTable.Table}}\", from: \"{{$fieldValue.LinkedTable.From}}\", to: \"{{$fieldValue.LinkedTable.To}}\", db: \"{{$fieldValue.LinkedTable.DB}}\", field: \"{{$fieldValue.LinkedTable.Field}}\" ) " +
		"{{else if and $fieldValue.LinkedTable.Table $fieldValue.LinkedTable.From $fieldValue.LinkedTable.To $fieldValue.LinkedTable.To $fieldValue.LinkedTable.DB}}" +
		"@link(table: \"{{$fieldValue.LinkedTable.Table}}\", from: \"{{$fieldValue.LinkedTable.From}}\", to: \"{{$fieldValue.LinkedTable.To}}\", db: \"{{$fieldValue.LinkedTable.DB}}\" ) " +
