...
func TestSQL_DescribeTable(t *testing.T) {
	...
	mysqlTestCases := []test{
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: "column1", FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeJSON), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
			isMssqlSkip: true,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		// Check Required fields(!)
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
		...
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeJSON), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
			isMssqlSkip: true,
		},
		...
		// NOTE: JSON & text type cannot have default value
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", FieldDefault: "INDIA", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", FieldDefault: "true", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
			isMssqlSkip: true,
		},
		{
			...
			foreignKeys:    []model.ForeignKeysType{},
			indexKeys:      []model.IndexType{},
			fields:         []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", FieldDefault: "1", VarcharSize: model.DefaultCharacterSize}},
			wantErr:        false,
			isPostgresSkip: true,
			isMysqlSkip:    true,
		},
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", FieldDefault: "100", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "NO", FieldDefault: "9.8", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", FieldDefault: "2020-05-30 00:42:05", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
			isMssqlSkip: true,
		},
		{
			...
			foreignKeys:    []model.ForeignKeysType{},
			indexKeys:      []model.IndexType{},
			fields:         []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", FieldDefault: "2020-05-30T00:42:05+00:00", VarcharSize: model.DefaultCharacterSize}},
			wantErr:        false,
			isMysqlSkip:    true,
			isPostgresSkip: true,
		},
		...
		// NOTE: We are only checking for type ID as currently space cloud supports that only
		{
			...
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", FieldKey: "PRI", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		...
		// NOTE: We cannot create foreign keys on string
		{
			...
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: secondColumn, FieldType: "varchar(50)", FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
		...
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", FieldKey: "PRI", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "yes"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", FieldKey: "PRI", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "yes"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", FieldKey: "PRI", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "yes"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "NO", FieldKey: "PRI", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "yes"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		// Type Id
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		// Type Integer
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Float
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Boolean
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Datetime
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "PRI", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Check Index Constraint
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
		...
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "no"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "no"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "no"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
			indexKeys:   []model.IndexType{{TableName: "table1", ColumnName: firstColumn, IndexName: getIndexName("table1", "index1"), Order: 1, Sort: model.DefaultIndexSort, IsUnique: "no"}},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		// Type Id
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		// Type Integer
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Float
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Boolean
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Datetime
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldKey: "MUL", FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
	...
	postgresTestCases := []test{
		...
		},
		{
			...
			fields:      []model.InspectorFieldType{{FieldName: "column1", FieldType: getSQLType(*dbType, model.TypeString), FieldNull: "YES", VarcharSize: model.DefaultCharacterSize}},
			foreignKeys: []model.ForeignKeysType{},
			indexKeys:   []model.IndexType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			indexKeys:   []model.IndexType{},
			foreignKeys: []model.ForeignKeysType{},
			fields:      []model.InspectorFieldType{{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeString), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
		...
		// TODO: FieldKey is empty
		{
			...
			foreignKeys: []model.ForeignKeysType{{TableName: "table2", ColumnName: secondColumn, RefTableName: "table1", RefColumnName: firstColumn, ConstraintName: getConstraintName("table1", firstColumn), DeleteRule: "NO ACTION"}},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
		...
		// Type Id
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeString), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		...
		},
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeJSON), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		},
		// Type String
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeString), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Integer
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeInteger), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Float
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeFloat), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Boolean
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeBoolean), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type Datetime
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeDateTime), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
		...
		// Type JSON
		{
			...
			fields: []model.InspectorFieldType{
				{FieldName: firstColumn, FieldType: getSQLType(*dbType, model.TypeJSON), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
				{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", VarcharSize: model.DefaultCharacterSize},
			},
			foreignKeys: []model.ForeignKeysType{},
			wantErr:     false,
	...
	mssqlTestCases := []test{
		...
		// NOTE: We cannot create foreign keys on string,
		{
			...
			foreignKeys: []model.ForeignKeysType{{TableName: "table2", ColumnName: secondColumn, RefTableName: "table1", RefColumnName: firstColumn, ConstraintName: getConstraintName("table1", firstColumn), DeleteRule: "NO ACTION"}},
			indexKeys:   []model.IndexType{},
			fields:      []model.InspectorFieldType{{FieldName: secondColumn, FieldType: getSQLType(*dbType, model.TypeID), FieldNull: "NO", FieldKey: "MUL", VarcharSize: model.DefaultCharacterSize}},
			wantErr:     false,
		},
		{
...
func getSQLType(dbType, typename string) string {
	...
	case model.TypeID:
		...
		return fmt.Sprintf("varchar(%d)", model.DefaultCharacterSize)
